...
SELECT ss.name,
	...
	cm.FT_enrollment,
	cm.PT_enrollment,
	cm.Perc_AmericanIndian_or_AlaskaNative_undergrad,
	cm.Perc_Asian_undergrad,
	cm.Perc_BlackAfricanAmerican_Undergrad,
	cm.Perc_HispanicLatino_undergrad,
	cm.Perc_NativeHawaiian_or_OtherPacificIslander_undergrad,
	cm.Perc_White_undergrad,
	cm.Perc_Multiracial_undergrad,
	cm.Perc_RaceUnknown_undergrad,
	cm.Perc_NonresidentAlien_undergrad,
	cm.Perc_AsianNativeHawaiianPacificIslander_undergrad,
	cm.Perc_women_undergrad,
	cm.Far_West_Region,
	cm.Great_Lakes_Region,
	cm.Mid_East_Region,
	cm.New_England_Region,
	cm.Plains_Region,
	cm.Rocky_Mountains_Region,
	cm.Southeast_Region,
	cm.Southwest_Region,
	cm.US_Service_Schools_Region,
	cl.cluster
INTO Combined_data_FINAL
FROM Cleaned_CU_w_Latlong as ll
...
on ll.name=ss.name
	...
	on ll.name=cr.name
		...
		on cm.CollegeID=ss.CollegeID
			LEFT OUTER JOIN clusters as cl
			on cm.CollegeID=cl.CollegeID
ORDER by ss.name;

Select *From Combined_data_FINAL;
